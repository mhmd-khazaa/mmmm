export const routes = {
  ...
  auth: {
    ...
    signUp2: "/auth/sign-up",
    signUp3: "/auth/sign-up",
    signUp4: "/auth/sign-up",
    signUp5: "/auth/sign-up",
    // sign in
    signIn1: "/auth/sign-in",
    signIn2: "/auth/sign-in",
    signIn3: "/auth/sign-in",
    signIn4: "/auth/sign-in",
    signIn5: "/auth/sign-in",
    // forgot password
    forgotPassword1: "/auth/forgot-password",
    forgotPassword2: "/auth/forgot-password",
    forgotPassword3: "/auth/forgot-password",
    forgotPassword4: "/auth/forgot-password",
    forgotPassword5: "/auth/forgot-password",
    // OTP
    otp1: "/auth/otp",
    otp2: "/auth/otp",
    otp3: "/auth/otp",
